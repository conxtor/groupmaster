...
func (l *connectorLease) loadSession(ctx context.Context) ([]byte, error) {
	...
	// gotd stores a versioned JSON session. Older GramJS StringSession values
	// are opaque base64 strings and must not make the client fail before QR
	// onboarding can recover the account.
