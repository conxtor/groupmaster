...
export default function LearningTermManager({ category, initialLanguage = "de" }: { category: Category; initialLanguage?: Language }) {
  ...
  useEffect(() => { void load().catch((value) => setError(value instanceof Error ? value.message : at("loadFailed"))); }, [category, language, search, groupId, page, pageSize]);
