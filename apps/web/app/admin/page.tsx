...
type Observability = {
  ...
  minio: { endpoint: string; bucket: string; connected: boolean; bucketExists: boolean; objectCount: number; totalBytes: number; lastModified?: string; error?: string };
