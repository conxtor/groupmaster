...
function ProfileContent() {
  ...
  const { locale, selectLocale, t } = useAuthLocale();
  ...
  return <main className="shell profilePage"><header className="pageHeading"><div><p className="eyebrow">CONXTOR</p><h1>{t("profileTitle")}</h1><p className="muted">{t("profileHint")}</p></div></header>
    <section className="authCard panel profileCard">
